...
"""
    ...
    gr.Examples(
        examples=[
            ...
            ["MTEB: Massive text embedding benchmark<|SEP|>BRIGHT: A Realistic and Challenging Benchmark for Reasoning-Intensive Retrieval<|SEP|>The Scandinavian Embedding Benchmarks: Comprehensive Assessment of Multilingual and Monolingual Text Embedding<|SEP|>FollowIR: Evaluating and Teaching Information Retrieval Models to Follow Instructions<|SEP|>Aya model: An instruction finetuned open-access multilingual language model<|SEP|>Scaling Data-Constrained Language Models<|SEP|>Bloom: A 176b-parameter open-access multilingual language model", 2],
        ],
